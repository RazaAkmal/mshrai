...
export default function Search(lan) {
  // console.warn(lan.lan);
  // const [arabic, setArabic] = useState(true);
  // if (lan.lan === "english") setArabic(false);
            ...
            <div className="col-12">
              <div className="cont">
                ...
                {lan.lan === "arabic" ? (
                  ...
                  <h1>The best platform to get the best used cars</h1>
                )}
                ...
                {lan.lan === "arabic" ? (
                  <p>ابحث في اكثر من موقع ومصدر لبيع السيارات المستعمله</p>
                ) : (
                  <p>Search more than one site and source to sell used cars</p>
                )}
              </div>
            </div>
          </div>
